...
<body class="bg-gray-50 " style="padding: 0px;">
    <div class="flex h-screen">
        ...
        <nav class="w-64 bg-blue-900 text-white h-screen fixed top-0 z-20">
            ...
            <!-- Navigation Links -->
            <div class="mt-6">
                <a href="dashboard.php" class="flex items-center px-6 py-3 hover:bg-blue-800 transition-colors duration-200">
                    <i class="fas fa-home w-5"></i>
                    <span class="ml-3">Dashboard</span>
                </a>
                <a href="score.php" class="flex items-center px-6 py-3 hover:bg-blue-800 transition-colors duration-200">
                    <i class="fas fa-book w-5"></i>
                    <span class="ml-3">Score&Opinion</span>
                </a>
